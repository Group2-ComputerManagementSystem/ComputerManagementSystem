...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   机房编号：<input name="jifanghao" type="text" id="jifanghao" style='border:solid 1px #000000; color:#666666' size="12" /> 
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="paike_list.jsp?scid=" onclick="return confirm('真的要删除？')">删除</a></td>
  </tr>
