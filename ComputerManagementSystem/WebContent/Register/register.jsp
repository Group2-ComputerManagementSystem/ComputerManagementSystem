...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="assets/ico/favicon.png"><!--修改图标-->
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="${pageContext.request.contextPath}/user/register.action" method="post" class="registration-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="text" name="form-email" placeholder="确认密码..." class="form-email form-control" id="form-email">
			                        </div>
